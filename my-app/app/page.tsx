      ...
      <main className="flex flex-col min-h-screen justify-center items-center p-24 bg-radial-gradient from-center to-edges">
        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className="flex space-x-4">
            ...
            <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-6 rounded-lg shadow-lg flex items-center focus:outline-none focus:shadow-outline" onClick={handleOpenClick}>
